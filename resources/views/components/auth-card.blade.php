<div class="min-h-screen flex items-stretch">
    ...
    {{-- 右侧表单区 --}}
    <div class="w-full lg:w-1/2 xl:w-2/5 flex flex-col justify-center items-center px-8 sm:px-12 py-12 bg-white relative">
        {{-- 背景装饰 --}}
        ...
        <div class="w-full max-w-sm relative z-10">
            ...
            <div class="flex items-center gap-2.5 mb-8 lg:hidden">
                ...
                <div>
                    <span class="text-lg font-bold text-slate-800 block leading-tight">{{ \App\Utils::config(\App\Enums\ConfigKey::AppName) }}</span>
                    <span class="text-xs text-slate-400">Image Hosting</span>
                </div>
            </div>
            {{ $slot }}
        </div>
