...
return [
    'app' => [
        ...
        ConfigKey::CustomCss => '',
        ConfigKey::CustomJs => '',
        ConfigKey::OauthEnable => 0,
        ConfigKey::OauthAllowRegister => 0,
        ConfigKey::OauthProviderName => 'OAuth 2.0',
        ConfigKey::OauthClientId => '',
        ConfigKey::OauthClientSecret => '',
        ConfigKey::OauthAuthorizeUrl => '',
        ConfigKey::OauthTokenUrl => '',
        ConfigKey::OauthUserinfoUrl => '',
        ConfigKey::OauthScope => 'openid profile email',
        ConfigKey::OauthUserIdField => 'sub',
        ConfigKey::OauthUserNameField => 'name',
        ConfigKey::OauthUserEmailField => 'email',
        ConfigKey::OauthPkceEnable => 1,
        ConfigKey::Mail => [
            'default' => 'smtp',
            'mailers' => [
                'smtp' => [
